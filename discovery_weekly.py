...
app.secret_key = 'sdufhwieufh34rr4$we&ik!n456676'
...
def save_discover_weekly():
    ...
    for playlist in current_playlists:
        ...
        print('Discover Weekly playlist ID:  ', discover_weekly_playlist_id)
        print('Saved Weekly playlist ID:     ', saved_weekly_playlist_id)
    ...
    sp.user_playlist_add_tracks(os.getenv("CLIENT_ID"), saved_weekly_playlist_id, song_uris, None)
...
def create_spotify_oauth():
    # Recuperar las variables desde .env
